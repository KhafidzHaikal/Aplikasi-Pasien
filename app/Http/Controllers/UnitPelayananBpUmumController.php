...
class UnitPelayananBpUmumController extends Controller
{
    ...
    {
        // dd(PelayananPasien::where('unit_pelayanans_id', '=', 1)->latest()->get());
    ...
    {
        // dd(KajianPasien::where('unit_pelayanans_id', '=', 1)->count());
        if (auth()->user()->type == 'admin') {
    ...
    public function print($tanggal_awal, $tanggal_akhir)
    {
        ...
        $pdf = Pdf::loadView('admin.bp_umum.pelayanan_pasiens.pdf', compact('pelayanan_pasiens', 'title', 'date', 'newTanggalAwal', 'newTanggalAkhir'))->setPaper('legal', 'landscape');
