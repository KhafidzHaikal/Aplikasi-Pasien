    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href={{ route('bp-gigi.create') }}>Kajian Pasien</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{-- Start Form --}}
                    <form action={{ route('bp-gigi.update', $pelayanan_pasiens->id) }} method="POST">
                        @method('put')
                        @csrf
