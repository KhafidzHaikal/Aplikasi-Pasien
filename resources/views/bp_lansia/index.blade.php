...
@section('body')
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4>Aplikasi Pelayanan Pasien Poli lansia</h4>
            </div>
        </div>
    ...
    <a class="btn btn-primary col-2 mb-xl-4" style="color:#ffff" href={{ route('bp-lansia.create') }}><i class="bi bi-person-add mr-2"></i> Tambah Pasien</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Laporan BP Lansia</h5>
                ...
                <div class="modal-footer">
                    ...
                    <a target="_blank" onclick="this.href='/print-laporan-bp-lansia/'+document.getElementById('tanggal_awal').value+ '/' +document.getElementById('tanggal_akhir').value" class="btn btn-primary">Cetak</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($pelayanan_pasiens as $pelayanan_pasien)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href={{ route('bp-lansia.edit', $pelayanan_pasien->id ) }} class="btn btn-warning mr-2"><i class="bi bi-pencil-square"></i></a>
                                            <a href={{ route('bp-lansia.show', $pelayanan_pasien->id ) }} class="btn btn-info mr-2"><i class="bi bi-info-circle"></i></a>
                                            <form action={{ route('bp-lansia.destroy', $pelayanan_pasien->id) }} method="POST">
                                                @method('delete')
                                                @csrf
