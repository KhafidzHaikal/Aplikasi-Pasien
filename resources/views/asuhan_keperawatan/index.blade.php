...
@section('body')
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Pelayanan Asuhan Keperawatan</a></li>
            </ol>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Laporan Asuhan Keperawatan</h5>
                ...
                <div class="modal-footer">
                    ...
                    <a target="_blank"
                        onclick="this.href='/askep/print-laporan-askep/'+document.getElementById('tanggal_awal').value+ '/' +document.getElementById('tanggal_akhir').value"
                            ...
                            <tbody>
                                @foreach ($askeps as $askep)
                                    <tr>
                                        ...
                                        <td>{{ $askep->tanggal_pengkajian->format('d-m-Y') }}</td>
