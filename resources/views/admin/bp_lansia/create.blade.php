...
@section('body')
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href={{ route('admin-bp-lansia.index') }}>Pelayanan Pasien</a></li>
                                    ...
                                    @foreach ($kajian_pasiens as $kajian_pasien)
                                        @if ($kajian_pasien->status == 'menunggu konfirmasi')
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    {{-- <a href={{ route('admin-bp-lansia.periksa', $kajian_pasien->pasiens_no_rm) }}
                                                        class="btn btn-warning mr-2"><i class="bi bi-search"></i></a> --}}
                                                    <form action={{ route('admin-bp-lansia.status', $kajian_pasien->id) }}
                                                        method="POST">
                                                        @method('put')
                                                        @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href={{ route('admin-bp-lansia.index') }} class="btn btn-dark"><i class="bi bi-check-lg"></i> Selesai</a>
                                            </td>
                                        </tr>
                                        @endif
                                    @endforeach
