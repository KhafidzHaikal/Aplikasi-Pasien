...
@section('body')
    ...
    <a class="btn btn-primary col-2 mb-xl-4" style="color:#ffff" href={{ route('admin-bp-lansia.create') }}><i
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a target="_blank"
                        onclick="this.href='/print-laporan-bp-lansia/'+document.getElementById('tanggal_awal').value+ '/' +document.getElementById('tanggal_akhir').value"
                            ...
                            <tbody>
                                @foreach ($pelayanan_pasiens as $pelayanan_pasien)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href={{ route('admin-bp-lansia.edit', $pelayanan_pasien->id) }}
                                                class="btn btn-warning mr-2"><i class="bi bi-pencil-square"></i></a>
                                            <a href={{ route('admin-bp-lansia.show', $pelayanan_pasien->id) }}
                                                class="btn btn-info mr-2"><i class="bi bi-info-circle"></i></a>
                                            <form action={{ route('admin-bp-lansia.destroy', $pelayanan_pasien->id) }}
                                                method="POST">
                                                @method('delete')
                                                @csrf
