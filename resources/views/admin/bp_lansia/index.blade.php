...
@section('body')
    ...
    <a class="btn btn-primary col-2 mb-xl-4" style="color:#ffff" href={{ route('admin-bp-lansia.create') }}><i class="bi bi-person-add mr-2"></i> Tambah Pasien</a>
                                ...
                                @foreach ($pelayanan_pasiens as $pelayanan_pasien)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <form action={{ route('admin-bp-lansia.destroy', $pelayanan_pasien->id) }} method="POST">
                                                @method('delete')
                                                @csrf
