...
@section('body')
    ...
    <a class="btn btn-primary col-2 mb-xl-4" style="color:#ffff" href={{ route('admin-poli-konseling.create') }}><i class="bi bi-person-add mr-2"></i> Tambah Pelayanan Pasien</a>
    <div class="row">
        <div class="col-12">
            <div class="card">
