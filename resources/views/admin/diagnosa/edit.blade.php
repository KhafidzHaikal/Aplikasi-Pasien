    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Diagnosa</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{-- Start Form --}}
                    <form action={{ route('admin-diagnosa.update', $diagnosa->kode_sdki) }} method="POST">
                        @method('put')
                        @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="kode_sdki"
                                            value="{{ old('kode_sdki', $diagnosa->kode_sdki) }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="nama_sdki"
                                            value="{{ old('nama_sdki', $diagnosa->nama_sdki) }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
