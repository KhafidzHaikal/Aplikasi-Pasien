                                    ...
                                    @foreach ($kajian_pasiens as $kajian_pasien)
                                        @if ($kajian_pasien->status == 'menunggu konfirmasi')
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    {{-- <a href={{ route('admin-poli-mtbs.periksa', $kajian_pasien->pasiens_no_rm) }}
                                                        class="btn btn-warning mr-2"><i class="bi bi-search"></i></a> --}}
                                                    <form action={{ route('admin-poli-mtbs.status', $kajian_pasien->id) }}
                                                        method="POST">
                                                        @method('put')
                                                        @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href={{ route('admin-poli-mtbs.index') }} class="btn btn-dark"><i class="bi bi-check-lg"></i> Selesai</a>
                                            </td>
                                        </tr>
                                        @endif
                                    @endforeach
