...
@section('body')
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4>Aplikasi Pelayanan Pasien Poli MTBS</h4>
            </div>
        </div>
    ...
    <a class="btn btn-primary col-2 mb-xl-4" style="color:#ffff" href={{ route('admin-poli-mtbs.create') }}><i class="bi bi-person-add mr-2"></i> Tambah Pasien</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Laporan Poli MTBS</h5>
                ...
                <div class="modal-footer">
                    ...
                    <a target="_blank" onclick="this.href='/print-laporan-poli-mtbs/'+document.getElementById('tanggal_awal').value+ '/' +document.getElementById('tanggal_akhir').value" class="btn btn-primary">Cetak</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($pelayanan_pasiens as $pelayanan_pasien)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href={{ route('admin-poli-mtbs.edit', $pelayanan_pasien->id ) }} class="btn btn-warning mr-2"><i class="bi bi-pencil-square"></i></a>
                                            <a href={{ route('admin-poli-mtbs.show', $pelayanan_pasien->id ) }} class="btn btn-info mr-2"><i class="bi bi-info-circle"></i></a>
                                            <form action={{ route('admin-poli-mtbs.destroy', $pelayanan_pasien->id) }} method="POST">
                                                @method('delete')
                                                @csrf
