...
@section('body')
    ...
    <a class="btn btn-primary col-2 mb-xl-4" style="color:#ffff" href={{ route('admin-bp-umum.create') }}><i
                            ...
                            <tbody>
                                @foreach ($pelayanan_pasiens as $pelayanan_pasien)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href={{ route('admin-bp-umum.edit', $pelayanan_pasien->id) }}
                                                class="btn btn-warning mr-2"><i class="bi bi-pencil-square"></i></a>
                                            <a href={{ route('admin-bp-umum.show', $pelayanan_pasien->id) }}
                                                class="btn btn-info mr-2"><i class="bi bi-info-circle"></i></a>
                                            <form action={{ route('admin-bp-umum.destroy', $pelayanan_pasien->id) }}
                                                method="POST">
                                                @method('delete')
                                                @csrf
