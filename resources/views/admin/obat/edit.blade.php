    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{-- Start Form --}}
                    <form action={{ route('admin-obat.update', $obat->no_obat) }} method="POST">
                        @method('put')
                        @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="date" class="form-control" name="tanggal_masuk"
                                            value="{{ old('tanggal_masuk', $obat->tanggal_masuk->toDateString()) }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group mb-3">
                                            ...
                                            value="{{ old('name', $obat->name) }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control" name="sediaan" id="tipeObat" required>
                                            ...
                                            <option value="Tablet"
                                                @if (old('sediaan', $obat->sediaan) == 'Tablet') {{ 'selected' }} @endif>Tablet</option>
                                            <option value="Syrop"
                                                @if (old('sediaan', $obat->sediaan) == 'Syrop') {{ 'selected' }} @endif>Syrop</option>
                                            <option value="Capsul"
                                                @if (old('sediaan', $obat->sediaan) == 'Capsul') {{ 'selected' }} @endif>Capsul</option>
                                            <option value="Supp"
                                                @if (old('sediaan', $obat->sediaan) == 'Supp') {{ 'selected' }} @endif>Supp</option>
                                            <option value="Pil"
                                                @if (old('sediaan', $obat->sediaan) == 'Pil') {{ 'selected' }} @endif>Pil</option>
                                            <option value="Injeksi"
                                                @if (old('sediaan', $obat->sediaan) == 'Injeksi') {{ 'selected' }} @endif>Injeksi
                                            </option>
                                            <option value="Puyer"
                                                @if (old('sediaan', $obat->sediaan) == 'Puyer') {{ 'selected' }} @endif>Puyer</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="date" class="form-control" name="tanggal_kadaluarsa"
                                            value="{{ old('tanggal_kadaluarsa', $obat->tanggal_kadaluarsa->toDateString()) }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
