                                    ...
                                    @foreach ($kajian_pasiens as $kajian_pasien)
                                        @if ($kajian_pasien->status == 'menunggu konfirmasi')
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    {{-- <a href={{ route('poli-kia.periksa', $kajian_pasien->pasiens_no_rm) }}
                                                        class="btn btn-warning mr-2"><i class="bi bi-search"></i></a> --}}
                                                    <form action={{ route('poli-kia.status', $kajian_pasien->id) }}
                                                        method="POST">
                                                        @method('put')
                                                        @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href={{ route('poli-kia.index') }} class="btn btn-dark"><i class="bi bi-check-lg"></i> Selesai</a>
                                            </td>
                                        </tr>
                                        @endif
                                    @endforeach
