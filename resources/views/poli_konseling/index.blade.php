...
@section('body')
    ...
    <a class="btn btn-primary col-2 mb-xl-4" style="color:#ffff" href={{ route('poli-konseling.create') }}><i class="bi bi-person-add mr-2"></i> Tambah Pasien</a>
                            ...
                            <tbody>
                                @foreach ($pelayanan_pasiens as $pelayanan_pasien)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href={{ route('poli-konseling.edit', $pelayanan_pasien->id ) }} class="btn btn-warning mr-2"><i class="bi bi-pencil-square"></i></a>
                                            <a href={{ route('poli-konseling.show', $pelayanan_pasien->id ) }} class="btn btn-info mr-2"><i class="bi bi-info-circle"></i></a>
                                            <form action={{ route('poli-konseling.destroy', $pelayanan_pasien->id) }} method="POST">
                                                @method('delete')
                                                @csrf
